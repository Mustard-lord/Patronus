    ...
    def adapt(self,
        ...
        * **allow_nograd** (bool, *optional*, default=None) - Whether to allow adaptation with
        ...
        if allow_nograd:
            ...
            # with open('params_requires_grad.txt', 'w') as f:
        ...
        if self.v is None:
            ...
            self.v = [self.momentum*self.v[i] + (1-self.momentum)*gradients[i] if self.v[i] is not None else None for i in range(len(gradients)) ]
        self.module = maml_update(self.module, self.lr,  self.v)
        # pdb.set_trace()
        return gradients
